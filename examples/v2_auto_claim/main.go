...
//
// 用法：
//   go run ./examples/v2_auto_claim status     查看当前授权状态
//   go run ./examples/v2_auto_claim enable     打开（CTF.setApprovalForAll(claimer, true)）
//   go run ./examples/v2_auto_claim disable    关闭（... false）
//
...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "  go run ./examples/v2_auto_claim status")
	fmt.Fprintln(os.Stderr, "  go run ./examples/v2_auto_claim enable")
	fmt.Fprintln(os.Stderr, "  go run ./examples/v2_auto_claim disable")
}
