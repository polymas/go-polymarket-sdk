...
// 用法：
//
//	PK=0x...                                  go run ./examples/claim_test   # 仅诊断
//	PK=0x... EXEC=0xabc... SIGTYPE=2          go run ./examples/claim_test   # 跑一笔
//	RPC=https://polygon.drpc.org PK=... ...   go run ./examples/claim_test   # 自定义 RPC
package main
