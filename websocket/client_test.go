...
func TestMarketClientProtocolAndEvents(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		events := `[
			...
			{"event_type":"last_trade_price","asset_id":"1","market":"` + testMarketConditionID + `","price":"0.456","size":"219.217767","fee_rate_bps":"0","side":"BUY","timestamp":"1757908892353","transaction_hash":"0xtrade"},
